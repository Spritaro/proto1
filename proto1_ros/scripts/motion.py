...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if joy_data.axes[5] >= 1.0:
            ...
            # right
            while True:
                set_servo(50, [ 10.,0.-20.,-130.,0.,0., -10.,0.-20.,-135.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # kick right
                set_servo(50, [ 30.,0.-20.,-130.,0.,0., -30.,0.-20.,-110.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # lift right
                set_servo(50, [ 30.,0.-20.,-135.,0.,0., -30.,0.-20.,-130.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # kick left
                set_servo(50, [ 10.,0.-20.,-110.,0.,0., -10.,0.-20.,-130.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # lift left
            ...
            # left
            while True:
                set_servo(50, [ 10.,0.-20.,-135.,0.,0., -10.,0.-20.,-130.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # kick right
                set_servo(50, [ 30.,0.-20.,-110.,0.,0., -30.,0.-20.,-130.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # lift right
                set_servo(50, [ 30.,0.-20.,-130.,0.,0., -30.,0.-20.,-135.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # kick left
                set_servo(50, [ 10.,0.-20.,-130.,0.,0., -10.,0.-20.,-110.,0.,0., 30.,-15.,-60.,  30.,-15.,-60.]) # lift left
                if not joy_data.axes[4] >= 1.0:
                    break
            set_servo(100, [ 20.,-20.,-100.,0.,0.,   -20.,-20.,-100.,0.,0., 30.,-15.,-60., 30.,-15.,-60.]) # crouch
            ...
            # turn right
            while True:
                set_servo(50, [  0.,-20.,-130.,0.,  0., -20.,-20.,-135.,0.,  0.,   0.+30.,-15.,-60.,   0.+30.,-15.,-60.]) # kick right
                set_servo(50, [  0.,-20.,-130.,0., 10., -20.,-20.,-110.,0.,-10., -10.+30.,-15.,-60.,  10.+30.,-15.,-60.]) # lift right
                set_servo(50, [  0.,-20.,-130.,0., 10., -20.,-20.,-130.,0.,-10., -10.+30.,-15.,-60.,  10.+30.,-15.,-60.]) # land right
                set_servo(50, [ 20.,-20.,-135.,0., 10.,   0.,-20.,-130.,0.,-10., -10.+30.,-15.,-60.,  10.+30.,-15.,-60.])
                set_servo(50, [ 20.,-20.,-110.,0.,  0.,   0.,-20.,-130.,0.,  0.,   0.+30.,-15.,-60.,   0.+30.,-15.,-60.])
                set_servo(50, [ 20.,-20.,-130.,0.,  0.,   0.,-20.,-130.,0.,  0.,   0.+30.,-15.,-60.,   0.+30.,-15.,-60.])
                if not joy_data.buttons[5] == 1:
                    break
            set_servo(100, [  20.,-20.,-110.,0.,0.,  -20.,-20.,-110.,0.,0., 0.,-15.,-60., 0.,-15.,-60.]) # crouch

        elif joy_data.buttons[4] == 1:
            # turn left
            while True:
                set_servo(50, [ 15.,-20.,-135.,0.,  0.,  -5.,-20.,-130.,0.,  0.,   0.+30.,-15.,-60.,   0.+30.,-15.,-60.]) # kick right
                set_servo(50, [ 15.,-20.,-110.,0., 20.,  -5.,-20.,-130.,0.,-20.,  20.+30.,-15.,-60., -20.+30.,-15.,-60.]) # lift right
                set_servo(50, [ 15.,-20.,-130.,0., 10.,  -5.,-20.,-130.,0.,-10.,  10.+30.,-15.,-60., -10.+30.,-15.,-60.]) # land right
                set_servo(50, [ -5.,-20.,-130.,0., 10., -25.,-20.,-135.,0.,-10.,  10.+30.,-15.,-60., -10.+30.,-15.,-60.])
                set_servo(50, [ -5.,-20.,-130.,0.,  0., -25.,-20.,-110.,0.,  0.,   0.+30.,-15.,-60.,   0.+30.,-15.,-60.])
                set_servo(50, [ -5.,-20.,-130.,0.,  0., -25.,-20.,-130.,0.,  0.,   0.+30.,-15.,-60.,   0.+30.,-15.,-60.])
                if not joy_data.buttons[4] == 1:
                    break
            set_servo(100, [ 20.,0.,-110.,0.,0.,  -20.,0.,-110.,0.,0., 0.,-15.,-60., 0.,-15.,-60.])
