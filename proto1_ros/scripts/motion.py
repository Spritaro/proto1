...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if joy_data.axes[5] >= 1.0:
            ...
            # get up front
            # set_servo(500, [ 0.,0.,-60.,0.,0.,   0.,0.,-60.,0.,0.,    0., 45.,-90.,     0., 45.,-90.])   # spread arms
            # set_servo(100, [ 0.,0.,-60.,0.,0.,   0.,0.,-60.,0.,0.,    0., 45.,-90.,     0., 45.,-90.])
            # set_servo(500, [ 0.,0.,-60.,0.,0.,   0.,0.,-60.,0.,0.,   90., 45.,-90.,    90., 45.,-90.])  # turn arms
            # set_servo(100, [ 0.,0.,-60.,0.,0.,   0.,0.,-60.,0.,0.,   90., 45.,-90.,    90., 45.,-90.])
            # set_servo(500, [ 0.,0.,-60.,0.,0.,   0.,0.,-60.,0.,0.,   90., 90., 60.,    90., 90., 60.])  # get ready
            # set_servo(100, [ 0.,0.,-60.,0.,0.,   0.,0.,-60.,0.,0.,   90., 90., 60.,    90., 90., 60.])
            # set_servo(500, [30.,0.,-40.,0.,0., -30.,0.,-40.,0.,0.,   90.,-60.,-90.,    90.,-60.,-90.])   # get up
            # set_servo(100, [30.,0.,-40.,0.,0., -30.,0.,-40.,0.,0.,   90.,-60.,-90.,    90.,-60.,-90.])
            # set_servo(500, [30.,0.,-40.,0.,0., -30.,0.,-40.,0.,0.,   30.,-30.,-90.,    30.,-30.,-90.])   # get up 2
            # set_servo(900, [30.,0.,-40.,0.,0., -30.,0.,-40.,0.,0.,   30.,-30.,-90.,    30.,-30.,-90.])
            # set_servo(500, [10.,-20.,-130.,0.,0., -10.,-20.,-130.,0.,0.,   0.,-30.,-60.,   0.,-30.,-60.])    # stand up
            # set_servo(100, [10.,-20.,-130.,0.,0., -10.,-20.,-130.,0.,0.,   0.,-30.,-60.,   0.,-30.,-60.])
            ...
            set_servo(200, [10.,-20.,-130.,0.,0., -10.,-20.,-130.,0.,0.,   0.,-30.,-60.,   0.,-30.,-60.])    # stand up
            set_servo(100, [10.,-20.,-130.,0.,0., -10.,-20.,-130.,0.,0.,   0.,-30.,-60.,   0.,-30.,-60.])
